...
- Merged to main through #33 (F0-S4 #30, S5 scope promotion #31, F0-S5 #32, north star + ADR
  acceptances #33/#34). **ALL fork ADRs F001..F008 are now `accepted`** (F007 + F008 by the
  maintainer, 2026-06-11). Merges follow ADR-F005's 5-part gate — no exceptions.
  **`docs/fork/NORTH-STAR.md` (maintainer, 2026-06-11) records the end state** — resident
  agents, forward deployment, community repo — with four keep-possible invariants; check
  structural slices against it.
