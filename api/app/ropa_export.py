...
**Honest scope.** GDPR Article 30(1) lists content the current two-tier domain
does not yet capture (categories of data subjects / personal data, recipients,
third-country transfers + safeguards — those arrive with PRIV-5). The export
RENDERS WHAT EXISTS and names the gap in a coverage note; it never invents the
missing fields. "System proposes, user owns" — the deliverable is honest, not
falsely complete.
"""
