...
F1-S4 wires reasoning deltas — is visible + testable) and the message actions bar, for visual +
interaction checks. The conversation/message primitives are exercised on the live chat surface
