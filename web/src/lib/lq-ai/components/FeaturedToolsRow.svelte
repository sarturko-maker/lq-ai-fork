  ...
  <section style="margin-bottom: var(--lq-space-6);">
    ...
    <div class="tools-grid">
      {#each tools as tool (tool.id)}
        <a href={tool.href} class="tool-card" aria-label={tool.title}>
          <span class="tool-icon" aria-hidden="true">{tool.icon}</span>
          <strong class="lq-text-panel-h" style="display: block; margin-bottom: var(--lq-space-1);">{tool.title}</strong>
          <p class="lq-text-body-sm" style="color: var(--lq-text-secondary); margin-bottom: var(--lq-space-3);">{tool.description}</p>
...
{:else}
  <section style="margin-bottom: var(--lq-space-6); display: flex; gap: var(--lq-space-2); flex-wrap: wrap; align-items: center;">
    <span class="lq-text-label" style="margin-right: var(--lq-space-1);">Tools:</span>
    {#each tools as tool (tool.id)}
      <a href={tool.href} class="tool-inline-btn" aria-label={tool.title}>
...
<style>
  ...
  .tool-card:hover { border-color: var(--lq-accent-border); }
  ...
  .tool-inline-btn:hover { border-color: var(--lq-accent-border); color: var(--lq-accent); }
</style>
